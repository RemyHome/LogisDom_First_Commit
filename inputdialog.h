...
public:
	...
	~inputDialog();
	static QString getTextPalette(QWidget *widget, const QString &title, const QString &label, QLineEdit::EchoMode mode = QLineEdit::Normal, const QString &text = QString(), bool *ok = 0, Qt::WindowFlags flags = 0, logisdom *parent = nullptr);
