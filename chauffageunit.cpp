...
void ChauffageUnit::changename()
{
	bool ok;
//retry:
	QString name = inputDialog::getTextPalette(this, cstr::toStr(cstr::Name), cstr::toStr(cstr::Name2dot), QLineEdit::Normal, RenameButton.text(), &ok, Qt::Dialog, maison1wirewindow);
...
ChauffageUnit *ChauffageScrollArea::AddEvent(QString Name)
{
	...
	{
Retry :
		name = inputDialog::getTextPalette(this, cstr::toStr(cstr::Name), cstr::toStr(cstr::Name2dot), QLineEdit::Normal, name, &ok, Qt::Dialog, maison1wirewindow);
