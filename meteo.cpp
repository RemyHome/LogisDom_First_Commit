        ...
        if (reply->error() == QNetworkReply::NoError)
        {
            ...
            for (int n=0; n<weathercom::weatherdaymax; n++)
            {
                ...
                if (WeathercomData[n].date.date() == today)
                {
                    ...
                    if ((hour == 5)|(hour == 6)) setWeatherIcon(IconeMeteo[1][0], &WeathercomData[n]);
                    else if ((hour == 11)|(hour == 12)) setWeatherIcon(IconeMeteo[2][0], &WeathercomData[n]);
                    else if ((hour == 17)|(hour == 18)) setWeatherIcon(IconeMeteo[3][0], &WeathercomData[n]);
                    else if ((hour == 20)|(hour == 21)) setWeatherIcon(IconeMeteo[4][0], &WeathercomData[n]);
                ...
                for (int j=1; j<(nbjours.currentIndex()+4); j++) // JourMax
                {
                    if (WeathercomData[n].date.date() == today.addDays(j))
                    {
                        ...
                        else if ((hour == 5)|(hour == 6)) setWeatherIcon(IconeMeteo[1][j], &WeathercomData[n]);
                        else if ((hour == 11)|(hour == 12)) setWeatherIcon(IconeMeteo[2][j], &WeathercomData[n]);
                        else if ((hour == 17)|(hour == 18)) setWeatherIcon(IconeMeteo[3][j], &WeathercomData[n]);
                        else if ((hour == 20)|(hour == 21)) setWeatherIcon(IconeMeteo[4][j], &WeathercomData[n]);
