...
devresol::devresol(net1wire *Master, logisdom *Parent, QString RomID) : onewiredevice(Master, Parent, RomID)
{
	...
	setupLayout.addWidget(&Address, layoutIndex, 1, 1, logisdom::PaletteWidth / 2);
	setupLayout.addWidget(&AddressListStr, layoutIndex++, 0, 1, logisdom::PaletteWidth / 2);
	...
	setupLayout.addWidget(&C10, layoutIndex++, 0, 1, logisdom::PaletteWidth);
