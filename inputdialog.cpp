...
QString inputDialog::getTextPalette(QWidget *widget, const QString &title, const QString &label, QLineEdit::EchoMode mode, const QString &text, bool *ok, Qt::WindowFlags, logisdom *parent)
{
	QString str;
