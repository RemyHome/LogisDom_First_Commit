...
QString name;
Retry:
	name = inputDialog::getTextPalette(this, cstr::toStr(cstr::Name), cstr::toStr(cstr::Name2dot), QLineEdit::Normal, "", &ok, Qt::Dialog, parent);
...
void addDaily::Rename()
{
	...
	if (index == -1) return;
	Retry:
	nom = inputDialog::getTextPalette(this, cstr::toStr(cstr::NewName), cstr::toStr(cstr::Name2dot), QLineEdit::Normal, dailyarray[index]->Name, &ok, Qt::Dialog, parent);
